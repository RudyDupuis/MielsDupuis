...
let colzaKg = {
    ...
    price: '10.00 €',
    desc : `Miel de colza aussi appellé « miel de printemps » est le premier miel de la saison. Il est composé en grande majorité de fleurs de Colza mais aussi de toutes les autres fleurs de printemps. C’est un miel dur et facile à tartiner. Je suis sûr que vous allez l’adorer !`,
    caract1 : "<strong>Texture :</strong> Dur",
    caract2 : "<strong>Goût :</strong> Doux",
...
let fleursKg = {
    ...
    price: '12.00 €',
    desc : `Miel de Fleurs est généralement récolté fin juin. La troisième récolte de l’année. Il est souvent composé en grande majorité de fleurs de tilleul, de châtaignier et de ronce mais aussi d’autres fleurs. Vu qu’il est composé d’un grand nombre de fleurs, chaque année, sa composition et son goût sont très différents. C’est un miel dur avec un goût corsé. Je suis sûr que vous allez l’adorer !`,
    caract1 : "<strong>Texture :</strong> Dur",
    caract2 : "<strong>Goût :</strong> Corsé",
    advice : `<strong>Conservation :</strong><br>La date de durabilité minimal (DDM) est de 2 ans après la mise en pot. Pour une bonne conservation du miel, gardez le pot fermé dans un endroit frais et sombre. `
}
let acaciaKg = {
    ...
    price: '16.00 €',
    desc : `Miel d’Acacia est généralement récolté fin mai. La seconde récolte de l’année. Il est composé en grande majorité de fleurs d’Acacia. C’est un miel qui reste liquide longtemps avec un goût léger. Je suis sûr que vous allez l’adorer !`,
    caract1 : "<strong>Texture :</strong> liquide",
    caract2 : "<strong>Goût :</strong> Doux",
    advice : `<strong>Conservation :</strong><br>La date de durabilité minimal (DDM) est de 2 ans après la mise en pot. Pour une bonne conservation du miel, gardez le pot fermé dans un endroit frais et sombre. `
}
let colzaG = {
...
let mielEtNoisettes = {
    ...
    price: '6.50 €',
    desc : `Préparation au miel de Colza onctueux mélangé avec de la poudre de noisette bio. Il remplacera vos pâtes à tartiner pour des petits déjeuners de qualité !`,
    caract1 : "<strong>Texture :</strong> Onctueuse",
    caract2 : "<strong>Goût :</strong> Doux",
...
let bougiePot = {
    ...
    price: '6.00 €',
    desc : `Bougie artisanale à la cire d’abeille avec une mèche en coton et aux huiles essentielles bio d’Ylang-Ylang, de Palmarosa et d’Orange douce. <br>Hauteur 8.5 cm | Diamètre 6.5 cm`,
    caract1 : "<strong>Flamme :</strong> Très grande",
    caract2 : "<strong>Durée :</strong> ≃ 20h",
...
let bougieLongue = {
    ...
    price: '4.00 €',
    desc : `Bougies longues à la cire d’abeille avec une mèche en coton. Les bougies sont réalisées à la main une à une. <br>Hauteur ≃ 20 cm | Diamètre ≃ 1.5 cm`,
    caract1 : "<strong>Flamme :</strong> Très grande",
    caract2 : "<strong>Durée :</strong> ≃ 4h",
